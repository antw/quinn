...
this.activeHandle),this.activeHandle=null};c.prototype.enableKeyboardEvents=function(a){e(a.target).on("keydown",this.handleKeyboardEvent);e(a.target).on("keyup",this.handleKeyboardEvent)};c.prototype.disableKeyboardEvents=function(a){e(a.target).off("keydown",this.handleKeyboardEvent);e(a.target).off("keyup",this.handleKeyboardEvent)};c.prototype.handleKeyboardEvent=function(a){if(a.type==="keydown"){if(this.previousValue==null&&!this.start())return false}else a.type==="keyup"&&this.previousValue!=
null&&this.resolve();switch(a.which){case 33:this.stepUp(10,false,true);break;case 34:this.stepDown(10,false,true);break;case 37:case 40:a.altKey?this.setTentativeValue(this.model.minimum,false):this.stepDown(a.shiftKey?10:1,false,true);break;case 39:case 38:a.altKey?this.setTentativeValue(this.model.maximum,false):this.stepUp(a.shiftKey?10:1,false,true);break;default:return true}a.preventDefault()};j.prototype.setValue=function(a,b){var d=this.values,c,f,a=g.isArray(a)?g.clone(a):[a];for(f=0,c=a.length;f<
c;f++)a[f]=this.sanitizeValue(a[f],b);if(g.isEqual(a,d))return false;this.value=this.values=a;if(this.values.length===1)this.value=a[0];return this.value};j.prototype.roundToStep=function(a){var b=1/this.step,b=Math.round(a*b)/b;g.isArray(this.only)&&(b=g.min(this.only,function(b){return Math.abs(b-a)}));if(b>this.maximum)return b-this.step;else if(b<this.minimum)return b+this.step;return b};j.prototype.sanitizeValue=function(a,b){b!==false&&(a=this.roundToStep(a));if(a>this.maximum)return this.maximum;
