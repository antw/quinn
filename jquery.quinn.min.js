...
function(a){var b=this.options,c=((this.value-this.range[0])/(this.range[1]-this.range[0])*100).toString()+"%";this.handle.stop(!0);this.activeBar.stop(!0);a&&b.effects?this.handle.animate({left:c},{duration:b.effectSpeed,step:e.bind(function(a){this.__positionActiveBar(a/100*(this.range[1]-this.range[0])+this.range[0])},this)}):(this.handle.css("left",c),this.__positionActiveBar(this.value))};c.prototype.__positionActiveBar=function(a){var b;a<0?(b=this.__positionForValue(a),a=this.__positionForValue(0)):
