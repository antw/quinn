...
this.renderer.render();!0===d.disable&&this.disable();this.trigger("setup",this.model.value)}function m(a,b){var d,h,c;this.options=d=a.options;this.step=d.step;this.only=d.only;this.values=[];this.minimum=this.roundToStep(d.min);this.maximum=this.roundToStep(d.max);this.minimum<d.min&&(this.minimum+=this.step);this.maximum>d.max&&(this.maximum-=this.step);d="undefined"===typeof d.value||null===d.value?this.minimum:f.isArray(d.value)?d.value:[d.value];c=0;for(h=d.length;c<h;c++)this.values[c]=null;
this.setValue(d,b)}var p="mousemove",q="mousedown",r="mouseup",s=!1;"ontouchstart"in document.documentElement&&(p="touchmove",q="touchstart",r="touchend",s=!0);c.VERSION="1.0.5";c.prototype.on=function(a,b){f.isString(a)&&f.isFunction(b)&&(this.callbacks[a]||(this.callbacks[a]=[]),this.callbacks[a].push(b));return this};c.prototype.trigger=function(a,b){var d=this.callbacks[a]||[],h=0,c;void 0===b&&(b=this.value);for(;c=d[h++];)if(!1===c(b,this))return!1;return!0};c.prototype.enable=function(){this.disabled&&
(this.disabled=!1,this.trigger("enabled"))};c.prototype.disable=function(){this.disabled||(this.disabled=!0,this.trigger("disabled"))};c.prototype.setValue=function(a,b,d){this.start()&&(!1!==this.setTentativeValue(a,b,d)?this.resolve():this.reject());return this.model.value};c.prototype.setTentativeValue=function(a,b,d){var c=this.model.value,g=null,e=null,k;if("undefined"===typeof a||null===a)return!1;if(1<this.model.values.length&&f.isNumber(a)){if(null===this.activeHandle)return!1;k=this.model.sanitizeValue(a);
a=f.clone(this.model.values);g=a[this.activeHandle-1];e=a[this.activeHandle+1];null!==g&&k<=g&&(k=g+this.options.step);null!==e&&k>=e&&(k=e-this.options.step);a[this.activeHandle]=k}a=this.model.setValue(a);if(!1===a||!d&&!this.trigger("drag",a))return this.model.setValue(c),!1!==a&&this.trigger("drag",c),!1;this.trigger("redraw",b);return a};c.prototype.stepUp=function(a,b,d){return 1<this.model.values.length?this.model.value:f.bind(d?this.setTentativeValue:this.setValue,this)(this.model.value+this.model.step*
