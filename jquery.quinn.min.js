...
this.setValue(a,!0),!1;else if(_.head(this.previousValues)===this.value)this.previousValues=_.tail(this.previousValues)};b.defaults={range:[0,100],selectable:null,step:1,value:null,onChange:null,onComplete:null,onSetup:null,effectSpeed:"fast",effects:!0}})(jQuery);
